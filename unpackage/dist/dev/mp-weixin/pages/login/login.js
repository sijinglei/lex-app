...
var _login = _interopRequireDefault(__webpack_require__(/*! ./pages/login/login.vue */ 242));
// @ts-ignore
...
/* harmony import */ var _login_vue_vue_type_template_id_b237504c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./login.vue?vue&type=template&id=b237504c& */ 243);
...
/* harmony import */ var _login_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./login.vue?vue&type=style&index=0&lang=css& */ 247);
...
var _default = {
  ...
  methods: {
    ...
    login: function login(e) {
      ...
      this.$store.dispatch('user/login', this.formData).then(function (res) {
        console.log('de==', res);
        if (res.code == 0) {
          uni.switchTab({
